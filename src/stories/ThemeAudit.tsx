...
const COLOUR_GROUPS: TokenGroup[] = [
    ...
    },
    {
        title: 'Text',
        tokens: [
            { name: '--text-main', used: 'Body, headings, primary button label(!), inputs' },
    ...
    },
    {
        title: 'Brand',
        tokens: [
            { name: '--brand-accent', used: 'Links, primary button, radio/switch on, header/footer rule, rose card border' },
            { name: '--brand-hover', used: 'Link/nav hover, primary hover, inline code text' },
            ...
            { name: '--accent-pink-soft', used: 'Syntax highlight functions/built-ins (.nf, .nb)' },
...
const CONTRAST_PAIRS: ContrastPair[] = [
    ...
    { label: 'Link', used: 'a on page', fg: 'var(--brand-accent)', bg: 'var(--bg-main)' },
    { label: 'Selected radio label', used: '.radio-option.selected', fg: 'var(--brand-accent)', bg: 'var(--bg-surface)' },
    { label: 'Nav / footer hover', used: '.page-link:hover', fg: 'var(--brand-hover)', bg: 'var(--bg-surface)' },
    { label: 'Inline code', used: ':not(pre) > code', fg: 'var(--brand-hover)', bg: 'var(--bg-overlay)' },
    { label: 'Primary button', used: '.btn / .btn-primary', fg: 'var(--text-main)', bg: 'var(--brand-accent)' },
    { label: 'Primary hover', used: '.btn-primary:hover', fg: 'var(--text-main)', bg: 'var(--brand-hover)' },
    { label: 'Primary pressed', used: '.btn-primary:active', fg: 'var(--text-main)', bg: 'var(--brand-active)' },
    { label: 'Success button', used: '.btn-success', fg: 'var(--color-success)', bg: 'rgb(var(--color-success-rgb) / 0.12)', over: 'var(--bg-surface)' },
    { label: 'Danger button', used: '.btn-danger', fg: 'var(--color-danger)', bg: 'rgb(var(--color-danger-rgb) / 0.12)', over: 'var(--bg-surface)' },
    ...
    { label: 'Disabled', used: 'disabled controls (also 50% opacity)', fg: 'var(--disabled-text)', bg: 'var(--disabled-bg)' },
    { label: 'Syntax: keyword', used: '.highlight .k — hardcoded #a855f7', fg: '#a855f7', bg: 'var(--bg-surface)' },
    { label: 'Syntax: string', used: '.highlight .s1 — hardcoded #34d399', fg: '#34d399', bg: 'var(--bg-surface)' },
    { label: 'Syntax: function', used: '.highlight .nf', fg: 'var(--accent-pink-soft)', bg: 'var(--bg-surface)' },
    { label: 'Field outline', used: 'input border', fg: 'var(--input-border)', bg: 'var(--input-bg)', kind: 'ui' },
